...
- Each query covers ONE angle using a short, natural search phrase. Do not stack synonyms, dates, arXiv, or "official blog OR paper" into it. Do not use Boolean, site:, or filetype: operators; providers differ. Preserve specific entity names and meaningful exact phrases; never truncate by word count.
